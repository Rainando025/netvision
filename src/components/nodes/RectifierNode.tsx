      ...
      <div className="p-4 flex flex-col gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[10px] text-muted-foreground uppercase tracking-wider">Retificadora DC</p>
          </div>
          <button
        ...
        <div className="bg-background/50 rounded p-2 text-center border border-border/50">
          <span className="text-[10px] text-muted-foreground block mb-0.5">Módulos</span>
          <span className="text-xs font-medium text-foreground">{data.modules} retificadores</span>
        </div>
      </div>
